...
print(output, " - correct answer is 12.7") # should be 12.7 with this example
...
"""
print(output)
print("Output should be:[[-9., 4.],[-9., 4.]]")
...
"""
print(output)
print("Output should be:[[  1.23394576e-04   9.82013790e-01], [  1.23394576e-04   9.82013790e-01]]")
